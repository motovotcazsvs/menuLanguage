...
*/
        ...
        Rectangle {
            ...
            Rectangle {
                ...
                Text {
                    ...
                    text: qsTr("ИЗМЕРЕНИЕ") + langTranslator.emptyString
        ...
        Rectangle {
            ...
            Rectangle {
                ...
                Text {
                    ...
                    text: qsTr("РЕЗУЛЬТАТЫ") + langTranslator.emptyString
        ...
        Rectangle {
            ...
            Rectangle {
                ...
                Text {
                    ...
                    text: qsTr("КОНТРОЛЬ") + langTranslator.emptyString
                ...
                Text {
                    ...
                    anchors.horizontalCenter: nameButton4.horizontalCenter
                    text: qsTr("КАЧЕСТВА") + langTranslator.emptyString
                    color: (recB4But1.pressed || recB4But2.pressed || recB4But3.pressed || recB4But4.pressed || recB4But5.pressed)
                    ? "white"
                    : "#9A8DCC"
                    font.family: "Helvetica"
        ...
        Rectangle {
            ...
            Rectangle {
                ...
                Text {
                    ...
                    text: qsTr("РАЗОГРЕВ") + langTranslator.emptyString
                    color: {
                        if(recB5But1.pressed || recB5But2.pressed || recB5But3.pressed || recB5But4.pressed|| recB5But5.pressed){
                            return "white"
                        }
        ...
        Rectangle {
            ...
            Rectangle {
                ...
                Text {
                    ...
                    text: qsTr("ОШИБКА") + langTranslator.emptyString
                    color: {
                        if(recB6But1.pressed || recB6But2.pressed || recB6But3.pressed || recB6But4.pressed || recB6But5.pressed){
                            return "white"
                        }
        ...
        Rectangle {
            ...
            Rectangle {
                ...
                Text {
                    ...
                    text: qsTr("СЛУЖЕБНЫЕ") + langTranslator.emptyString
        ...
        Rectangle {
            ...
            Rectangle {
                ...
                Text {
                    ...
                    text: qsTr("КАЛИБРОВКА") + langTranslator.emptyString
                    color: {
                        if(recB8But1.pressed || recB8But2.pressed || recB8But3.pressed || recB8But4.pressed|| recB8But5.pressed){
                            return "white"
                        }
        ...
        Rectangle {
            ...
            Rectangle {
                ...
                Text {
                    ...
                    text: qsTr("КРОВЬ") + langTranslator.emptyString
        ...
        Rectangle {
            ...
            Rectangle {
                ...
                Text {
                    ...
                    text: qsTr("СЫВОРОТКА") + langTranslator.emptyString
        ...
        Rectangle {
            ...
            Rectangle {
                ...
                Text {
                    ...
                    text: qsTr("СТАНДАРТ") + langTranslator.emptyString
    ...
    Page {
        ...
        Column {
            ...
            Button {
                text: qsTr("УКРАИНСКИЙ") + langTranslator.emptyString
                onClicked: {
                    langTranslator.setTranslation("ua_UA");
                }
            }

            Button {
                text: qsTr("АНГЛИЙСКИЙ") + langTranslator.emptyString
                onClicked: {
                    langTranslator.setTranslation("en_US");
                }
            }

            Button {
                text: qsTr("РУССКИЙ") + langTranslator.emptyString
                onClicked: {
                    langTranslator.setTranslation("ru_RU");
                }
            }
